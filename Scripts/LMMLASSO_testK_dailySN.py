...
plt.xlabel('Observed Seed Number')
plt.ylabel('Predicted Seed Number')
...
plt.savefig('PredvsObs_KLIMIX_dailySN.png')
...
resultspd.to_csv("Results_KLIMIX_dailySN.csv")