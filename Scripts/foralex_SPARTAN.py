...
os.chdir("/data/projects/punim0543/andhikap/foralex"
np.save("weights_01pc1.npy",weights_01pc1)
np.save("kprop_01pc1.npy",kprop_01pc1)
...
os.chdir("/data/projects/punim0543/andhikap/foralex"
np.save("weights_005pc1.npy",weights_005pc1)
np.save("kprop_005pc1.npy",kprop_005pc1)
...
os.chdir("/data/projects/punim0543/andhikap/foralex"
np.save("weights_005pc2.npy",weights_005pc2)
np.save("kprop_005pc2.npy",kprop_005pc2)
...
os.chdir("/data/projects/punim0543/andhikap/foralex"
np.save("weights_01pc2.npy",weights_01pc2)
np.save("kprop_01pc2.npy",kprop_01pc2)