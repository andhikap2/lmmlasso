'''
Making figures to show the effects of changing Th
...
env250=pd.read_csv('Microclimate_Daily_threshold_3_0.csv',sep=',')
env500=pd.read_csv('Microclimate_Weekly_threshold_5_0.csv',sep=',')
env1000=pd.read_csv('Microclimate_Monthly_threshold_7_0.csv',sep=',')
