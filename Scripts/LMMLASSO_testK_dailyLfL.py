#For testing different K-matrices
import sys
...
K=np.load("K_MATRIX_PYIBS0.1.npy")
...
plt.xlabel('Observed Leaf Length (mm) ')
plt.ylabel('Predicted Leaf Length (mm)')
...
plt.savefig('PredvsObs_KPYIBS0.1_dailyLfL.png')
...
resultspd.to_csv("Results_KPYIBS0.1_dailyLfL.csv")