'''
Making figures to show the effects of changing Period
...
env0=pd.read_csv('Microclimate_Hourly_threshold_0_0.csv',sep=',')
env250=pd.read_csv('Microclimate_Daily_threshold_0_0.csv',sep=',')
env500=pd.read_csv('Microclimate_Weekly_threshold_0_0.csv',sep=',')
env1000=pd.read_csv('Microclimate_Monthly_threshold_0_0.csv',sep=',')
...
plt.legend((custom_lines),('Hourly','Daily','Weekly','Monthly'),loc='upper left',frameon=True,fontsize='small')

os.chdir("/srv/uom-data1-q.unimelb.edu.au/6300-afournier/home/student.unimelb.edu.au/andhikap/Clim_GWAS/LMMLASSO/Figures")


plt.savefig('PredvsObs_Period.png')
